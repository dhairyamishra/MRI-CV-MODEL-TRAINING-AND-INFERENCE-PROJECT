...
def check_models_exist():
    ...
    print("=" * 80)
    print(f"Classifier:    {'✓ Found' if models_status['classifier'] else '✗ Not found'} ({classifier_path})")
    print(f"Segmentation:  {'✓ Found' if models_status['segmentation'] else '✗ Not found'} ({segmentation_path})")
    print(f"Calibration:   {'✓ Found' if models_status['calibration'] else '✗ Not found'} ({calibration_path})")
    print("=" * 80)
